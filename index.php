...
<body>
	...
	<div class="page">
		...
		<h3>Moyens techniques</h3>
			<p>
				La page est propulsée par un serveur web Arch Linux, sous PHP 7.4.7 et Python 3.8.3. Tous les calculs et les modélisations sont effectués à l'aide de Python via le langage PHP.
			</p>
	</div>
</body>
</html>
