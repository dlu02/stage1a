	...
	<div class="page">
		<h2 class="titre">Tests statistiques</h2>
			...
			<h3>Contexte</h3>
				...
				et nous fixons $\alpha=0.05$ la règle de décision.</p>
				...
				<p>Si la p-value retournée par le test dépasse $\alpha$, alors nous ne pouvons pas rejeter l'hypothèse $(H_0)$ et dans le cas contraire, nous pouvons rejeter l'hypothèse $(H_0)$.</p>
